...
const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[10vh] shrink-0 scale-[0.45] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 mt-[-8em] mb-[-8em] md:mt-32 md:mb-20"
    >
      <motion.h2
        style={{
    ...
    <div className="mx-1 h-full rounded-md bg-[#050505] p-1">
      ...
      <Row>
        <KBtn className="" childrenClassName="h-full justify-between py-[4px]">
          ...
          <div className="flex w-full justify-start pl-1"></div>
        </KBtn>
        <KBtn className="" childrenClassName="h-full justify-between py-[4px]">
