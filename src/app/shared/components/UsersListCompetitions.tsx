              ...
              <MeteorsCard>
                ...
                {!user && (
                  <>
                    ...
                    <button
                      className="mt-6 bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-0.5 text-lg font-semibold leading-6 text-white inline-block"
                      onClick={() => {
